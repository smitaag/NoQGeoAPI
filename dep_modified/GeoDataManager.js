...
var GeoDataManager = /** @class */ (function () {
    ...
    GeoDataManager.prototype.getGeoHashKey = function (lat, lon) {
        var geoPoint = { "latitude": lat, "longitude": lon };
        var hash = S2Manager_1.S2Manager.generateGeohash(geoPoint);
        var hashKey = S2Manager_1.S2Manager.generateHashKey(hash, this.config.hashKeyLength);
